...
const PORT = 3000;
const ALLOWED_HOSTS = new Set(['drive.google.com','drive.usercontent.google.com','docs.google.com','docs.googleusercontent.com']);
...
async function startServer() {
  ...
  // The playable web client is allowed to load only committed Bannon GLBs.
  // No generated primitive/fallback actor is exposed by this route.
  app.use('/BannonSource', express.static(path.join(process.cwd(), 'BannonSource'), {
    fallthrough: false,
