...
export default function GameBattleArena({
  ...
  useEffect(() => {
    ...
    const loop = (now: number) => {
      ...
      const TRIGGER_STATES = new Set(['lightAttack', 'heavyAttack', 'hit', 'Hitstun', 'HitStun', 'knockdown', 'Knockdown', 'ko', 'KO', 'Crumple', 'WakeupTechRoll', 'WakeupBackrise', 'WakeupQuickStand']);
