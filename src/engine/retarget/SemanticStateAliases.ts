...
export const SEMANTIC_STATE_ALIASES: Record<string, string[]> = {
  ...
  attack_1:       ['lightAttack', 'LightAttack', 'BOXING', 'BODY_JAB_CROSS', 'COMBO_PUNCH', 'BOXING__1_', 'BOXING__2_', 'punch', 'Punch', 'jab', 'Jab', 'attack', 'Attack', 'LP', 'T_1', 'bf_jab', 'attack_1_procedural_placeholder'],
  attack_2:       ['heavyAttack', 'HeavyAttack', 'HURRICANE_KICK', 'DROP_KICK', 'ILLEGAL_KNEE', 'TIGER_FEINT_KICK', 'BASH', 'kick', 'Kick', 'cross', 'Cross', 'RP', 'T_2', 'bf_cross', 'attack_2_procedural_placeholder'],
  ...
  grapple:        ['grab', 'Grab', 'SUPLEX', 'GERMANSUPLEX', 'DDT', 'CHOKESLAM', 'throw', 'Throw', 'grapple', 'Grapple', 'SBW_throw', 'T_1_3'],
