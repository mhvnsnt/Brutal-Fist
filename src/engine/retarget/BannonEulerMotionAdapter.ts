...
export const SEMANTIC_PREFERRED_CLIPS: Record<string, string[]> = {
  ...
  attack_rp:      ['COMBO_PUNCH', 'BOXING__2_', 'ILLEGAL_ELBOW_PUNCH', 'ILLEGAL_ELBOW_PUNCH__1_', 'BASEBALL_HIT', 'BOXING__5_'],
  ...
  run:            ['DRUNK_RUN_FORWARD', 'LOCO_LIGHT', 'LOCO_STALK', 'LOCO_LUMBER'],
  dash_forward:   ['DRUNK_RUN_FORWARD', 'LOCO_STRUT', 'LOCO_STALK'],
  jump:           ['BIG_JUMP', 'CROSS_JUMPS'],
  taunt:          ['TAUNT_CALLOUT', 'TAUNT_ARMS_WIDE', 'TAUNT_POINT', 'TAUNT_FLEX', 'BREAKDANCE_READY', 'STANCE_BLADED', 'CAPOEIRA'],
